...
class FirstMatrix extends StatelessWidget {
  @override
...
class firstMatrix extends StatefulWidget {
  @override
  _firstMatrixState createState() => _firstMatrixState();
}
          ...
          Column(
            ...
            children: [
              AppBar(
                ...
                elevation: 0,
                title: Text("\t\t\t\tFirst Matrix", textAlign: TextAlign.center, style: TextStyle(
                  fontSize: 30,
