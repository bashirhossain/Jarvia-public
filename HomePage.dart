          ...
          Column(
            ...
            children: [
              AppBar(
                ...
                elevation: 0,
                title: Text("       \tAll Tasks", textAlign: TextAlign.center, style: TextStyle(
                    fontSize: 30,
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      for(var i = 0; i < 15; i++)
                         taskWidget(Colors.red, "Meeting with Batman" , "19/07/2021,  9:00")


                      //taskWidget(Colors.black38, "Eid" , "21/07/2021,  20:00"),
                     // taskWidget(Colors.blue, "Dating with Captain Marvel" , "23/07/2021,  15:00"),
                      //taskWidget(Colors.green, "Wake up for Class" , "25/07/2021,  7:30"),
                    ],
                  ),
                ),
              ),
