...
class SecondMatrix extends StatelessWidget {
  @override
...
class secondMatrix extends StatefulWidget {
  @override
  _secondMatrixState createState() => _secondMatrixState();
}

class _secondMatrixState extends State<secondMatrix> {
          ...
          Column(
            ...
            children: [
              AppBar(
                ...
                elevation: 0,
                title: Text("\t\t\t\tSecond Matrix", textAlign: TextAlign.center, style: TextStyle(
                  fontSize: 30,
