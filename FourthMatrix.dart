...
class FourthMatrix extends StatelessWidget {
  @override
...
class fourthMatrix extends StatefulWidget {
  @override
  _fourthMatrixState createState() => _fourthMatrixState();
}

class _fourthMatrixState extends State<fourthMatrix> {
          ...
          Column(
            ...
            children: [
              AppBar(
                ...
                elevation: 0,
                title: Text("\t\t\t\tFourth Matrix", textAlign: TextAlign.center, style: TextStyle(
                  fontSize: 30,
